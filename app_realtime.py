...
def index():
    ...
    # Get video_index from URL parameter (if any)
    ...
    # Update stream_url with new video_index
    ...
    if video_index == 0:
        fig = px.choropleth_mapbox(
            ...
            zoom=15,
            center={"lat": 35.6936, "lon": 139.6991},
            opacity=0.5,
        ...
        fig = px.choropleth_mapbox(
            ...
            mapbox_style='open-street-map',
            zoom=15,
            center={"lat": 39.5473, "lon": -107.3247},
            opacity=0.5,
            labels={'name': 'Traffic Situation'},
            width=750,
            height=560,
